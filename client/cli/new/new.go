...
import (
	...
	tmpl "github.com/btccom/go-micro-platform/v2/internal/template"
	"github.com/btccom/go-micro-platform/v2/internal/usage"
...
func protoComments(goDir, alias string) []string {
	return []string{
		...
		"go get github.com/btccom/go-micro-platform/v2/cmd/protoc-gen-micro",
...
func copyAPIProto(c config) (string, error) {
	...
	if err != nil {
		return "", errors.New("Unable to find go-micro version. Please try `go get github.com/btccom/go-micro/v2`")
	}
	newestDir := ""
