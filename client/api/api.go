...
import (
	...
	ahandler "github.com/btccom/go-micro/v2/api/handler"
	aapi "github.com/btccom/go-micro/v2/api/handler/api"
	"github.com/btccom/go-micro/v2/api/handler/event"
	ahttp "github.com/btccom/go-micro/v2/api/handler/http"
	arpc "github.com/btccom/go-micro/v2/api/handler/rpc"
	"github.com/btccom/go-micro/v2/api/handler/web"
	"github.com/btccom/go-micro/v2/api/resolver"
	"github.com/btccom/go-micro/v2/api/resolver/grpc"
	"github.com/btccom/go-micro/v2/api/resolver/host"
	"github.com/btccom/go-micro/v2/api/resolver/path"
	"github.com/btccom/go-micro/v2/api/router"
	regRouter "github.com/btccom/go-micro/v2/api/router/registry"
	"github.com/btccom/go-micro/v2/api/server"
	"github.com/btccom/go-micro/v2/api/server/acme"
	"github.com/btccom/go-micro/v2/api/server/acme/autocert"
	"github.com/btccom/go-micro/v2/api/server/acme/certmagic"
